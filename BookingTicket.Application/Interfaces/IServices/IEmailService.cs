...
namespace BookingTicket.Application.Interfaces.IServices
{
    public interface IEmailService
    {
        ...
        Task SendMidTripDropOffConfirmationAsync(string to, string customerName, string bookingCode, string routeName, string dropOffLocation, string approvalLink, string rejectionLink);
    }
}
